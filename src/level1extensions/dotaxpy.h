#ifndef ULMBLAS_SRC_LEVEL1EXTENSIONS_DOTAXPY_H
#define ULMBLAS_SRC_LEVEL1EXTENSIONS_DOTAXPY_H 1
...
#endif // ULMBLAS_SRC_LEVEL1EXTENSIONS_DOTAXPY_H 1

#include <src/level1extensions/dotaxpy.tcc>
