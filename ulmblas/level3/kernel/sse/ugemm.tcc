#ifndef ULMBLAS_LEVEL3_KERNEL_SSE_UGEMM_TCC
#define ULMBLAS_LEVEL3_KERNEL_SSE_UGEMM_TCC 1
      ...
      const double   *nextB)
{
    long kb      = kc / 4;
    long kl      = kc % 4;
    long incRowC = _incRowC;
    long incColC = _incColC;
...
#endif // ULMBLAS_LEVEL3_KERNEL_SSE_UGEMM_TCC 1
