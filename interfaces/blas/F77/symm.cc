...
void
F77BLAS(ssymm)(const char     *side_,
               const char     *upLo_,
               const int      *m_,
               const int      *n_,
               const float    *alpha_,
...
void
F77BLAS(csymm)(const char     *side_,
               const char     *upLo_,
               const int      *m_,
               const int      *n_,
               const float    *alpha_,
...
void
F77BLAS(zsymm)(const char     *side_,
               const char     *upLo_,
               const int      *m_,
               const int      *n_,
               const double   *alpha_,
